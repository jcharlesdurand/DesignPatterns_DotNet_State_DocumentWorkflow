...
namespace DocumentWorkflowApplication.States
{
    public class InReviewState : DocumentState
    {
        ...
        {
            Console.WriteLine("Cannot publish: document still in review");
        }

        public override void Edit(string newContent)
        {
            Console.WriteLine("Cannot edit: document is locked during review");
        }

        public override void Archive()
        {
            Console.WriteLine("Cannot archive a document in review");
        }
